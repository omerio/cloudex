 ...
 *
 */
public class CmdLineAuthenticationProvider implements AuthenticationProvider<Credential> {

    private final static Log log = LogFactory.getLog(CmdLineAuthenticationProvider.class);

    /** Directory to store user credentials. */
    private static final java.io.File DATA_STORE_DIR =
            new java.io.File(System.getProperty("user.home"), ".store/cloudex_google");
    ...
    protected Credential getCredential() throws IOException {
        Validate.notNull(this.clientSecretsFile);
